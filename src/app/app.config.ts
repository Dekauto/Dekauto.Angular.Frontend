...
export const diploma_supplement_export_url = `${backend_api_url}/export/diploma-supplement`;
...
export const diploma_supplement_export_default_name = "Приложение диплома";
